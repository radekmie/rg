...
import $15puzzleRbg from 'bundle-text:../../../../games/rbg/15puzzle.rbg';
...
import AmazonsSplit2aRbg from 'bundle-text:../../../../games/rbg/amazons_split2a.rbg';
import AmazonsSplit3Rbg from 'bundle-text:../../../../games/rbg/amazons_split3.rbg';
import AmazonsSplit5Rbg from 'bundle-text:../../../../games/rbg/amazons_split5.rbg';
import AmazonsSplit5plusRbg from 'bundle-text:../../../../games/rbg/amazons_split5plus.rbg';
...
import Breakthrough10x10Rbg from 'bundle-text:../../../../games/rbg/breakthrough_10x10.rbg';
import Breakthrough11x11Rbg from 'bundle-text:../../../../games/rbg/breakthrough_11x11.rbg';
import Breakthrough12x12Rbg from 'bundle-text:../../../../games/rbg/breakthrough_12x12.rbg';
import Breakthrough5x5Rbg from 'bundle-text:../../../../games/rbg/breakthrough_5x5.rbg';
import Breakthrough6x6Rbg from 'bundle-text:../../../../games/rbg/breakthrough_6x6.rbg';
import Breakthrough7x7Rbg from 'bundle-text:../../../../games/rbg/breakthrough_7x7.rbg';
import Breakthrough9x9Rbg from 'bundle-text:../../../../games/rbg/breakthrough_9x9.rbg';
import BreakthroughSplitRbg from 'bundle-text:../../../../games/rbg/breakthrough_split.rbg';
...
import FoxAndHounds10x10Rbg from 'bundle-text:../../../../games/rbg/foxAndHounds-10x10.rbg';
import FoxAndHounds12x12Rbg from 'bundle-text:../../../../games/rbg/foxAndHounds-12x12.rbg';
...
import GomokuStandard11x11Rbg from 'bundle-text:../../../../games/rbg/gomoku_standard_11x11.rbg';
import GomokuStandard13x13Rbg from 'bundle-text:../../../../games/rbg/gomoku_standard_13x13.rbg';
import HexRbg from 'bundle-text:../../../../games/rbg/hex.rbg';
import Hex10x10Rbg from 'bundle-text:../../../../games/rbg/hex_10x10.rbg';
import Hex5x5Rbg from 'bundle-text:../../../../games/rbg/hex_5x5.rbg';
import Hex6x6Rbg from 'bundle-text:../../../../games/rbg/hex_6x6.rbg';
import Hex7x7Rbg from 'bundle-text:../../../../games/rbg/hex_7x7.rbg';
import Hex8x8Rbg from 'bundle-text:../../../../games/rbg/hex_8x8.rbg';
...
import KnightthroughSplitRbg from 'bundle-text:../../../../games/rbg/knightthrough_split.rbg';
...
import Reversi10x10Rbg from 'bundle-text:../../../../games/rbg/reversi_10x10.rbg';
import Reversi4x4Rbg from 'bundle-text:../../../../games/rbg/reversi_4x4.rbg';
import Reversi6x6Rbg from 'bundle-text:../../../../games/rbg/reversi_6x6.rbg';
...
// prettier-ignore
const games = [
  ['15puzzle', $15puzzleRbg, Language.rbg],
  ['Amazons (naive)', AmazonsNaiveHrg, Language.hrg],
  ['Amazons (smart)', AmazonsSmartHrg, Language.hrg],
  ['Amazons (split2)', AmazonsSplit2Rbg, Language.rbg],
  ['Amazons (split2a)', AmazonsSplit2aRbg, Language.rbg],
  ['Amazons (split3)', AmazonsSplit3Rbg, Language.rbg],
  ['Amazons (split5)', AmazonsSplit5Rbg, Language.rbg],
  ['Amazons (split5+)', AmazonsSplit5plusRbg, Language.rbg],
  ...
  ['Breakthrough (split)', BreakthroughSplitRbg, Language.rbg],
  ['Breakthrough', BreakthroughRg, Language.rg],
  ['Breakthrough (opt)', BreakthroughOptRg, Language.rg],
  ['Breakthrough (5x5)', Breakthrough5x5Rbg, Language.rbg],
  ['Breakthrough (6x6)', Breakthrough6x6Rbg, Language.rbg],
  ['Breakthrough (7x7)', Breakthrough7x7Rbg, Language.rbg],
  ['Breakthrough (9x9)', Breakthrough9x9Rbg, Language.rbg],
  ['Breakthrough (10x10)', Breakthrough10x10Rbg, Language.rbg],
  ['Breakthrough (11x11)', Breakthrough11x11Rbg, Language.rbg],
  ['Breakthrough (12x12)', Breakthrough12x12Rbg, Language.rbg],
  ...
  ['FoxAndHounds (10x10)', FoxAndHounds10x10Rbg, Language.rbg],
  ['FoxAndHounds (12x12)', FoxAndHounds12x12Rbg, Language.rbg],
  ...
  ['Gomoku (standard, 11x11)', GomokuStandard11x11Rbg, Language.rbg],
  ['Gomoku (standard, 13x13)', GomokuStandard13x13Rbg, Language.rbg],
  ['Hex', HexRbg, Language.rbg],
  ['Hex (5x5)', Hex5x5Rbg, Language.rbg],
  ['Hex (6x6)', Hex6x6Rbg, Language.rbg],
  ['Hex (7x7)', Hex7x7Rbg, Language.rbg],
  ['Hex (8x8)', Hex8x8Rbg, Language.rbg],
  ['Hex (9x9)', Hex9x9Rbg, Language.rbg],
  ['Hex (10x10)', Hex10x10Rbg, Language.rbg],
  ...
  ['Reversi (4x4)', Reversi4x4Rbg, Language.rbg],
  ['Reversi (6x6)', Reversi6x6Rbg, Language.rbg],
  ['Reversi (10x10)', Reversi10x10Rbg, Language.rbg],
