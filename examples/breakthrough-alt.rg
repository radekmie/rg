...
type Direction = Position -> PositionOrNull;
...
const upLeft: Direction = {:null,
v11:v00,v12:v01,v13:v02,v14:v03,v15:v04,v16:v05,v17:v06,
v21:v10,v22:v11,v23:v12,v24:v13,v25:v14,v26:v15,v27:v16,
v31:v20,v32:v21,v33:v22,v34:v23,v35:v24,v36:v25,v37:v26,
v41:v30,v42:v31,v43:v32,v44:v33,v45:v34,v46:v35,v47:v36,
v51:v40,v52:v41,v53:v42,v54:v43,v55:v44,v56:v45,v57:v46,
v61:v50,v62:v51,v63:v52,v64:v53,v65:v54,v66:v55,v67:v56,
v71:v60,v72:v61,v73:v62,v74:v63,v75:v64,v76:v65,v77:v66};
const upRight: Direction = {:null,
v01:v10,v02:v11,v03:v12,v04:v13,v05:v14,v06:v15,v07:v16,
v11:v20,v12:v21,v13:v22,v14:v23,v15:v24,v16:v25,v17:v26,
v21:v30,v22:v31,v23:v32,v24:v33,v25:v34,v26:v35,v27:v36,
v31:v40,v32:v41,v33:v42,v34:v43,v35:v44,v36:v45,v37:v46,
v41:v50,v42:v51,v43:v52,v44:v53,v45:v54,v46:v55,v47:v56,
v51:v60,v52:v61,v53:v62,v54:v63,v55:v64,v56:v65,v57:v66,
v61:v70,v62:v71,v63:v72,v64:v73,v65:v74,v66:v75,v67:v76};
...
const downLeft: Direction = {:null,
v10:v01,v11:v02,v12:v03,v13:v04,v14:v05,v15:v06,v16:v07,
v20:v11,v21:v12,v22:v13,v23:v14,v24:v15,v25:v16,v26:v17,
v30:v21,v31:v22,v32:v23,v33:v24,v34:v25,v35:v26,v36:v27,
v40:v31,v41:v32,v42:v33,v43:v34,v44:v35,v45:v36,v46:v37,
v50:v41,v51:v42,v52:v43,v53:v44,v54:v45,v55:v46,v56:v47,
v60:v51,v61:v52,v62:v53,v63:v54,v64:v55,v65:v56,v66:v57,
v70:v61,v71:v62,v72:v63,v73:v64,v74:v65,v75:v66,v76:v67};
const downRight: Direction = {:null,
v00:v11,v01:v12,v02:v13,v03:v14,v04:v15,v05:v16,v06:v17,
v10:v21,v11:v22,v12:v23,v13:v24,v14:v25,v15:v26,v16:v27,
v20:v31,v21:v32,v22:v33,v23:v34,v24:v35,v25:v36,v26:v37,
v30:v41,v31:v42,v32:v43,v33:v44,v34:v45,v35:v46,v36:v47,
v40:v51,v41:v52,v42:v53,v43:v54,v44:v55,v45:v56,v46:v57,
v50:v61,v51:v62,v52:v63,v53:v64,v54:v65,v55:v66,v56:v67,
v60:v71,v61:v72,v62:v73,v63:v74,v64:v75,v65:v76,v66:v77};
...
setFinished, checkOwn: board[pos] == pieceOfPlayer[currentPlayer];
checkOwn, selectDir: board[pos] = Piece(e);

selectDir, forwardDirCheck: $ F;
forwardDirCheck, forwardDirGrab: pos = FDirOfPlayer[currentPlayer][pos];
forwardDirGrab, forwardMove: pos != PositionOrNull(null);
forwardMove, moved: board[Position(pos)] == Piece(e);

selectDir, leftDirCheck: $ L;
leftDirCheck, diagMoveCheck: pos = LDirOfPlayer[currentPlayer][pos];
selectDir, rightDirCheck: $ R;
rightDirCheck, diagMoveCheck: pos = RDirOfPlayer[currentPlayer][pos];
diagMoveCheck, diagDestCheck: pos != PositionOrNull(null);
diagDestCheck, moved: opponentOrEmpty[currentPlayer][board[Position(pos)]] == Bool(1);

moved, done: board[pos] = pieceOfPlayer[currentPlayer];
done, wincheck: player = PlayerOrKeeper(keeper);

wincheck, win: FDirOfPlayer[currentPlayer][pos] == PositionOrNull(null);
wincheck, continue: FDirOfPlayer[currentPlayer][pos] != PositionOrNull(null);
