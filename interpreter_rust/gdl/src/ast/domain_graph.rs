...
mod test {
    ...
    fn example_4() {
        ...
        let domain_1 = BTreeSet::from(["0", "50", "100"]);
        let domain_2 = BTreeSet::from(["1", "2", "3"]);
        let domain_3 = BTreeSet::from(["control"]);
        let domain_4 = BTreeSet::from(["control", "mark"]);
        let domain_5 = BTreeSet::from(["noop", "play"]);
        let domain_6 = BTreeSet::from(["o", "x"]);
        let domain_7 = BTreeSet::from(["oPlayer", "xPlayer"]);
        assert_eq!(graph.domain(&Custom("col", 0)), domain_2);
        assert_eq!(graph.domain(&Custom("col", 1)), domain_6);
        assert_eq!(graph.domain(&Custom("control", 0)), domain_7);
        assert_eq!(graph.domain(&Custom("diag", 0)), domain_6);
        assert_eq!(graph.domain(&Custom("emptyCell", 0)), domain_2);
        assert_eq!(graph.domain(&Custom("emptyCell", 1)), domain_2);
        assert_eq!(graph.domain(&Custom("index", 0)), domain_2);
        assert_eq!(graph.domain(&Custom("line", 0)), domain_6);
        assert_eq!(graph.domain(&Custom("mark", 0)), domain_2);
        assert_eq!(graph.domain(&Custom("play", 0)), domain_2);
        assert_eq!(graph.domain(&Custom("play", 1)), domain_2);
        assert_eq!(graph.domain(&Custom("play", 2)), domain_6);
        assert_eq!(graph.domain(&Custom("row", 0)), domain_2);
        assert_eq!(graph.domain(&Custom("row", 1)), domain_6);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_BASE, 0)), domain_4);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_DOES, 0)), domain_7);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_DOES, 1)), domain_5);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_GOAL, 0)), domain_7);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_GOAL, 1)), domain_1);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_INIT, 0)), domain_3);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_INPUT, 0)), domain_7);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_INPUT, 1)), domain_5);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_LEGAL, 0)), domain_7);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_LEGAL, 1)), domain_5);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_NEXT, 0)), domain_4);
        assert_eq!(graph.domain(&Order(Term::<()>::ORDER_ROLE, 0)), domain_7);
